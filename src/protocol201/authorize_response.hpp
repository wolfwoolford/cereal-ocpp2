...
SCHEMA_ENUM(AuthorizeCertificateStatusEnum,\
    Accepted,\
    SignatureError,\
    CertificateExpired,\
    CertificateRevoked,\
    ...
    CertChainError,\
    ContractCancelled);
using AuthorizeCertificateStatusEnumType=schema_enum_value<AuthorizeCertificateStatusEnum>;

struct AuthorizeResponse
{
    optional<AuthorizeCertificateStatusEnumType> certificateStatus;
