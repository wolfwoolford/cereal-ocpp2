...
struct VariableAttributeType
{
    ...
    void serialize(Archive& archive)
    {
        ...
        cereal::nvp(archive, "persistent", persistent);
...
struct NotifyReportRequest
{
    ...
    optional<schema_array<ReportDataType,65536,1>> reportData;
    int requestId;
    int seqNo;
